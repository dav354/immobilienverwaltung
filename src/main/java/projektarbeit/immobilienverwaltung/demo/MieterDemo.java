    ...
    private void loadMieterData() {
        if (mieterRepository.count() == 0) { // Only load if no data exists
            ...
            if (!wohnungen.isEmpty()) {
                Mieter mieter1 = new Mieter(wohnungen.get(0), "Doe", "John", "0123456789", 3000, 1000, LocalDate.of(2023, 1, 1), LocalDate.of(2024, 1, 1), 1000, 2);
                mieterRepository.save(mieter1);

                Mieter mieter2 = new Mieter(wohnungen.get(1), "Doe", "Jane", "9876543210", 4000, 1200, LocalDate.of(2023, 6, 1), LocalDate.of(2024, 6, 1), 1200, 3);
                mieterRepository.save(mieter2);

                Mieter mieter3 = new Mieter(wohnungen.get(2), "Mustermann", "Max", "1234567890", 2500, 800, LocalDate.of(2022, 5, 1), LocalDate.of(2023, 5, 1), 900, 1);
                mieterRepository.save(mieter3);

                Mieter mieter4 = new Mieter(wohnungen.get(3), "Mustermann", "Erika", "0987654321", 2800, 900, LocalDate.of(2023, 3, 1), LocalDate.of(2024, 3, 1), 1000, 2);
                mieterRepository.save(mieter4);

                Mieter mieter5 = new Mieter(wohnungen.get(0), "Schmidt", "Peter", "0123456788", 3200, 1100, LocalDate.of(2022, 2, 1), LocalDate.of(2023, 2, 1), 1100, 2);
                mieterRepository.save(mieter5);

                Mieter mieter6 = new Mieter(wohnungen.get(1), "Schneider", "Laura", "9876543211", 4200, 1300, LocalDate.of(2023, 7, 1), LocalDate.of(2024, 7, 1), 1300, 3);
