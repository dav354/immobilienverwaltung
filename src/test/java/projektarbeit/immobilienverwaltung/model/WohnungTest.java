...
class WohnungTest {
    ...
    public void setUp() {
        ...
        testWohnung = new Wohnung("Musterstraße", "11", "Test", "Musterstadt", Land.DE, 200, 2000, 2, 2, false, false, false, false);
    }

    @Test
    public void testValidAdresse() {
        wohnung = new Wohnung("Musterstraße", "11", "Test", "Musterstadt", Land.DE, 200, 2000, 2, 2, false, false, false, false);
    ...
    public void testNullQuadratmeter() {
        wohnung = new Wohnung("Musterstraße", "11", "Test", "Musterstadt", Land.DE, 0, 2000, 2, 2, false, false, false, false);
        Set<ConstraintViolation<Wohnung>> violations = validator.validate(wohnung);
    ...
    public void testNegativeQuadratmeter() {
        wohnung = new Wohnung("Musterstraße", "11", "Test", "Musterstadt", Land.DE, -1, 2000, 2, 2, false, false, false, false);
        Set<ConstraintViolation<Wohnung>> violations = validator.validate(wohnung);
    ...
    public void testNullBaujahr() {
        wohnung = new Wohnung("Musterstraße", "11", "Test", "Musterstadt", Land.DE, 200, 0, 2, 2, false, false, false, false);
        Set<ConstraintViolation<Wohnung>> violations = validator.validate(wohnung);
    ...
    public void testThreeDigitBaujahr() {
        wohnung = new Wohnung("Musterstraße", "11", "Test", "Musterstadt", Land.DE, 200, 111, 2, 2, false, false, false, false);
        Set<ConstraintViolation<Wohnung>> violations = validator.validate(wohnung);
    ...
    public void testFutureBaujahr() {
        wohnung = new Wohnung("Musterstraße", "11", "Test", "Musterstadt", Land.DE, 200, 4444, 2, 2, false, false, false, false);
        Set<ConstraintViolation<Wohnung>> violations = validator.validate(wohnung);
    ...
    public void testNullAnzahlBaeder() {
        wohnung = new Wohnung("Musterstraße", "11", "Test", "Musterstadt", Land.DE, 200, 2000, 0, 2, false, false, false, false);
        Set<ConstraintViolation<Wohnung>> violations = validator.validate(wohnung);
    ...
    public void testNullAnzahlSchlafzimmer() {
        wohnung = new Wohnung("Musterstraße", "11", "Test", "Musterstadt", Land.DE, 200, 2000, 2, 0, false, false, false, false);
        Set<ConstraintViolation<Wohnung>> violations = validator.validate(wohnung);
