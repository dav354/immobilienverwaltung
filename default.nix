...
pkgs.stdenv.mkDerivation {
  ...
  shellHook = ''
    ...
    pandoc docs/index.md docs/motivation.md docs/verwendungszweck.md docs/zieluser.md docs/installation.md docs/technologien.md docs/komponenten.md docs/databaseDesign.md docs/useCases.md --pdf-engine=pdflatex -o "$OUTPUT_DIR/$OUTPUT_FILE"
